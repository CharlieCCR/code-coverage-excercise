...
//var muliplier = require('./services/muliplier');
...
app.get("/muliply", function (req, res) {
    res.send(handleCalculatorRequest(muliplier.multiple, req.query.numberA, req.query.numberB));
});
